...
class ScheduleTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Gym.Map.ScheduleTableMap';
     ...
     */
    const OM_CLASS = '\\Gym\\Schedule';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Gym.Schedule';
     ...
     */
    const COL_NAME = 'schedule.name';

    /**
     * the column name for the from field
     */
    const COL_FROM = 'schedule.from';

    /**
     * the column name for the to field
     */
    const COL_TO = 'schedule.to';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Name', 'From', 'To', ),
        self::TYPE_CAMELNAME     => array('id', 'name', 'from', 'to', ),
        self::TYPE_COLNAME       => array(ScheduleTableMap::COL_ID, ScheduleTableMap::COL_NAME, ScheduleTableMap::COL_FROM, ScheduleTableMap::COL_TO, ),
        self::TYPE_FIELDNAME     => array('id', 'name', 'from', 'to', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Name' => 1, 'From' => 2, 'To' => 3, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'name' => 1, 'from' => 2, 'to' => 3, ),
        self::TYPE_COLNAME       => array(ScheduleTableMap::COL_ID => 0, ScheduleTableMap::COL_NAME => 1, ScheduleTableMap::COL_FROM => 2, ScheduleTableMap::COL_TO => 3, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'name' => 1, 'from' => 2, 'to' => 3, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Gym\\Schedule');
        $this->setPackage('Gym');
    ...
    {
        $this->addRelation('Exercise', '\\Gym\\Exercise', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':schedule_id',
    1 => ':id',
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(ScheduleTableMap::COL_NAME);
            $criteria->addSelectColumn(ScheduleTableMap::COL_FROM);
            $criteria->addSelectColumn(ScheduleTableMap::COL_TO);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Gym\Schedule) { // it's a model object
